            ...
            <section className={classes.body}>
                ...
                <section className={classes.header}>
                    <div className={classes.name}>
                        <Typography variant='display4' color="whiteText"> James Dibnah <Typography variant='display1' color="whiteText" className={classes.nameChild}> Software developer </Typography></Typography>
                    </div>
                </section>
